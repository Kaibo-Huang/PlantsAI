              ...
              {searchResults.length === 2 ? (
                <li>
                  <button
                    ...
                    onClick={() =>
                      flyToLocation(searchResults[0], searchResults[1])
                    }
                  >
                ...
                searchResults.map((result, idx) => (
                  <li key={idx}>
                    ...
                    >
                      {result.properties?.plant?.results?.[0]?.species
                        ?.scientificName ||
                        result.properties?.plant?.bestMatch ||
                        "No plant info"}
                      <br />
                      <span style={{ fontSize: 14, color: "#aee9c7" }}>
