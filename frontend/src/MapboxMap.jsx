...
import Weather from "./Weather"; // <-- ADD THIS LINE
    ...
    <div style={{ position: "relative", height: "100%" }}>
      ...
      {showPopup && (
        ...
        >
          ...
          >
            <span>
              Lat: {pendingPin?.lat.toFixed(4)}, Lng:{" "}
              {pendingPin?.lng.toFixed(4)}
            </span>
          </div>
          ...
          >
            <FormControlLabel
              control={
                <Switch
                  checked={alertForCare}
                  onChange={(e) => setAlertForCare(e.target.checked)}
                  color="success"
                />
              }
              label={
            ...
            <FormControlLabel
              control={
                <Switch
                  checked={favoriteOnMap}
                  onChange={(e) => setFavoriteOnMap(e.target.checked)}
                  color="success"
                />
              }
              label={
      ...
      {showDeletePopup && (
        ...
        >
          ...
          >
            <span>
              Lat: {deletePin?.lat?.toFixed(4)}, Lng:{" "}
